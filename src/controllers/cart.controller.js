...
//       message: "Error in getting all carts",
//       error: error.message,
//     });
//   }
// };
...
//     const job = await Cart.create(req.body);
...
//   const { id } = req.params;
//   try {
//     const job = await Cart.findByIdAndUpdate(id, req.body, { new: true });
...
// export { getAllCarts, createCart, getCart, updateCart, deleteCart };
